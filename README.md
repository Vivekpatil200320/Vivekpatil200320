...
Autonomous AI Agents: Engineering self-healing Python agents using LangGraph and Ollama.

Local LLM Infrastructure: Deploying private, quantized models (Qwen, Llama) for secure coding environments.

Full-Stack Ecosystems: Sharpening my skills in Next.js, MERN stack, and scalable backend architectures.
